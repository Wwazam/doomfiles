...
**** Files
#+begin_src elisp
(setq org-agenda-files '("~/documents/notes/roam/inbox.org" "~/documents/notes/roam/work/" "~/documents/notes/roam/errands/" "~/documents/notes/roam/home/" "~/documents/notes/roam/computer/"))
#+end_src
**** Keymap
#+begin_src elisp
...
(defun todo-template (letter name)
  (let* ((downcase-name (downcase name)))
    `(,letter ,name entry (file ,(format "%s/inbox.org" downcase-name)) "* TODO %?\n")))
...
(setq org-capture-templates
      `(("t" "Todo")
        ...
        ("p" "Project")
        ("pn" "New" plain (function visit-file) (file "templates/project.org"))))
