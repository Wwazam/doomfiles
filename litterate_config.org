...
'(("r" "Reference")
  ("ra" "Article" plain "\%?"
   :target (file+head "reference/article/%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+author: ${author}\n#+source: ${source}\n#+date: %^{date}t"))
  ("rb" "Book" plain "\%?"
   :target (file+head "reference/book/%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+author: ${author}\n#+year: ${year}")))
#+end_src

****** Setting the variable
#+headers: :var ref=reference_templates()
#+begin_src elisp 
